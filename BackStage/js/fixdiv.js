...
(function() {
    ...
    f = {
        ...
        hotTemplate: {
            ...
            title: '<div class="address_hotcity"><strong>\u70ed\u95e8\u57ce\u5e02</strong><span style="color:#fff;">{$text}</span></div>',
        ...
        function L() {
            ...
            f.hotTarget = u;
                ...
                if (a) {
                    ...
                    p.style.backgroundColor = arr.length ? "#F7982A" : "#F18A13";
                    if (!arr || !arr.length) {
